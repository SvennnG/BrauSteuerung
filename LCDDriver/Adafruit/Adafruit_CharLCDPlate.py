...
from LCDDriver.Adafruit.Adafruit_I2C import Adafruit_I2C
...
class Adafruit_CharLCDPlate(Adafruit_I2C):
    ...
    def hasError(self):
        try:
            bus = Adafruit_I2C(self.i2caddr, self.i2cbusnum, self.i2cdebug)
            return False
        except:
            print("Adafruit_CharLCDPlate:hasError:True")
